...
exports.RequirementsTreeProvider = void 0;
const vscode = __importStar(require("vscode"));
class RequirementsTreeProvider {
    constructor() {
    ...
    createTreeItem(label, state) {
        const item = new vscode.TreeItem(label, state);
        return item;
    }
}
exports.RequirementsTreeProvider = RequirementsTreeProvider;
//# sourceMappingURL=requirementsTreeProvider.js.map